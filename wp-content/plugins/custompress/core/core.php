	...
	*/
	...
	function on_enqueue_scripts(){
		...
		if(!empty($lang))
		{
			...
			//wp_register_script('jquery-ui-datepicker-lang', $this->plugin_url . "datepicker/js/i18n/jquery.ui.datepicker-$lang.js", array('jquery','jquery-ui-datepicker'), '1.8.18');	  	    	  				 								//error fixed by nayab			wp_register_script('jquery-ui-datepicker-lang', $this->plugin_url . "datepicker/js/i18n/jquery.ui.datepicker-en.js", array('jquery','jquery-ui-datepicker'), '1.8.18');
		}
