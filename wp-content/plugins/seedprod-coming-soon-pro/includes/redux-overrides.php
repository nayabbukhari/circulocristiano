...
add_action('wp_dashboard_setup', 'seed_cspv4_remove_redux_dashboard',999);
function seed_cspv4_remove_redux_dashboard() {
...
function seed_cspv4_addButtons() {
    ...
    jQuery( document ).ready(function($) {
        $( "<a target=\'_blank\' class=\'seed_csvp4_preview button button-primary\' href=\''.home_url().'?seed_cspv4_preview=true\' style=\'margin-right:3px;\'>'.__('Preview','seedprod').'</a>" ).prependTo( ".redux-action_bar" );
