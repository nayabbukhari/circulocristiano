...
// Don't duplicate me!
    if ( ! class_exists( 'SeedReduxFramework_section' ) ) {

        /**
         * Main SeedReduxFramework_heading class
         *
         * @since       1.0.0
         */
        class SeedReduxFramework_section {
            ...
            public function render() {
                ...
                echo '<div id="section-' . $this->field['id'] . '" class="seedredux-section-field seedredux-field ' . $this->field['style'] . $this->field['class'] . '">';
                ...
                if ( ! empty( $this->field['subtitle'] ) ) {
                    echo '<div class="seedredux-section-desc">' . $this->field['subtitle'] . '</div>';
                }
                ...
                <script type="text/javascript">
                    jQuery( document ).ready(
                        function() {
                            ...
                            var group = jQuery( '#<?php echo $this->field['id']; ?>-marker' ).parents( '.seedredux-group-tab:first' );
                            if ( !group.hasClass( 'sectionsChecked' ) ) {
                                group.addClass( 'sectionsChecked' );
                                var test = group.find( '.seedredux-section-indent-start h3' );
                                jQuery.each(
            ...
            public function enqueue() {
                if ( $this->parent->args['dev_mode'] ) {
                    wp_enqueue_style(
                        'seedredux-field-section-css',
                        SeedReduxFramework::$_url . 'inc/fields/section/field_section.css',
                        array(),
                        time(),
                        'all'
                    );
