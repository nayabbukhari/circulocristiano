...
(function( $ ) {
    ...
    seedredux.field_objects.color_gradient = seedredux.field_objects.color_gradient || {};

    $( document ).ready(
        function() {
            //        setTimeout(function () {
            //            seedredux.field_objects.color.init();
            //        }, 1000);
        }
    );

    seedredux.field_objects.color_gradient.init = function( selector ) {

        if ( !selector ) {
            selector = $( document ).find( ".seedredux-group-tab:visible" ).find( '.seedredux-container-color_gradient:visible' );
        }
