...
// Don't duplicate me!
if ( ! class_exists( 'SeedReduxFramework_editor' ) ) {

    /**
     * Main SeedReduxFramework_editor class
     *
     * @since       1.0.0
     */
    class SeedReduxFramework_editor {
        ...
        public function enqueue() {
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'seedredux-field-editor-css',
                    SeedReduxFramework::$_url . 'inc/fields/editor/field_editor.css',
                    array(),
                    time(),
                    'all'
                );
            ...
            wp_enqueue_script(
                'seedredux-field-editor-js',
                SeedReduxFramework::$_url . 'inc/fields/editor/field_editor' . SeedRedux_Functions::isMin() . '.js',
