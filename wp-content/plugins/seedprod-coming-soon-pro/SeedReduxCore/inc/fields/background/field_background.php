...
// Don't duplicate me!
    if ( ! class_exists( 'SeedReduxFramework_background' ) ) {

        /**
         * Main SeedReduxFramework_background class
         *
         * @since       3.1.5
         */
        class SeedReduxFramework_background {
            ...
            public function render() {
                ...
                if ( $this->field['background-color'] === true ) {
                    ...
                    echo '<input data-id="' . $this->field['id'] . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-color]" id="' . $this->field['id'] . '-color" class="seedredux-color seedredux-background-input seedredux-color-init ' . $this->field['class'] . '"  type="text" value="' . $this->value['background-color'] . '"  data-default-color="' . ( isset( $this->field['default']['background-color'] ) ? $this->field['default']['background-color'] : "" ) . '" />';
                    echo '<input type="hidden" class="seedredux-saved-color" id="' . $this->field['id'] . '-saved-color' . '" value="">';
                    ...
                    if ( ! isset( $this->field['transparent'] ) || $this->field['transparent'] !== false ) {
                        ...
                        echo '<label for="' . $this->field['id'] . '-transparency" class="color-transparency-check"><input type="checkbox" class="checkbox color-transparency seedredux-background-input ' . $this->field['class'] . '" id="' . $this->field['id'] . '-transparency" data-id="' . $this->field['id'] . '-color" value="1"' . $tChecked . '> ' . __( 'Transparent', 'seedredux-framework' ) . '</label>';
                    }
                ...
                if ( $this->field['background-repeat'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . __( 'Background Repeat', 'seedredux-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-repeat]" class="seedredux-select-item seedredux-background-input seedredux-background-repeat ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-clip'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . __( 'Background Clip', 'seedredux-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-clip]" class="seedredux-select-item seedredux-background-input seedredux-background-clip ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-origin'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . __( 'Background Origin', 'seedredux-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-origin]" class="seedredux-select-item seedredux-background-input seedredux-background-origin ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-size'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-repeat-select" data-placeholder="' . __( 'Background Size', 'seedredux-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-size]" class="seedredux-select-item seedredux-background-input seedredux-background-size ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-attachment'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-attachment-select" data-placeholder="' . __( 'Background Attachment', 'seedredux-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-attachment]" class="seedredux-select-item seedredux-background-input seedredux-background-attachment ' . $this->field['class'] . '">';
                    echo '<option></option>';
                    foreach ( $array as $k => $v ) {
                ...
                if ( $this->field['background-position'] === true ) {
                    ...
                    echo '<select id="' . $this->field['id'] . '-position-select" data-placeholder="' . __( 'Background Position', 'seedredux-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-position]" class="seedredux-select-item seedredux-background-input seedredux-background-position ' . $this->field['class'] . '">';
                    echo '<option></option>';
                ...
                if ( $this->field['background-image'] === true ) {
                    ...
                    $placeholder = isset( $this->field['placeholder'] ) ? $this->field['placeholder'] : __( 'No media selected', 'seedredux-framework' );

                    echo '<input placeholder="' . $placeholder . '" type="text" class="seedredux-background-input ' . $hide . 'upload ' . $this->field['class'] . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[background-image]" id="' . $this->parent->args['opt_name'] . '[' . $this->field['id'] . '][background-image]" value="' . $this->value['background-image'] . '" />';
                    ...
                    echo '<img class="seedredux-option-image" id="image_' . $this->value['media']['id'] . '" src="' . $this->value['media']['thumbnail'] . '" alt="" target="_blank" rel="external" />';
                    echo '</a>';
                    echo '</div>';
                    ...
                    echo '<span class="button seedredux-background-upload" id="' . $this->field['id'] . '-media">' . __( 'Upload', 'seedredux-framework' ) . '</span>';
                    ...
                    echo '<span class="button removeCSS seedredux-remove-background' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . __( 'Remove', 'seedredux-framework' ) . '</span>';
            ...
            public function enqueue() {
                ...
                wp_enqueue_script(
                    'seedredux-field-background-js',
                    SeedReduxFramework::$_url . 'inc/fields/background/field_background' . SeedRedux_Functions::isMin() . '.js',
                ...
                if ($this->parent->args['dev_mode']) {
                    wp_enqueue_style(
                        'seedredux-field-background-css',
                        SeedReduxFramework::$_url . 'inc/fields/background/field_background.css',
                        array(),
                        time(),
                        'all'
                    );
