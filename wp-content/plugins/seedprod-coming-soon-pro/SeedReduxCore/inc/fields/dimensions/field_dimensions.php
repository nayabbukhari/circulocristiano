<?php
    ...
    if ( ! class_exists( 'SeedReduxFramework_dimensions' ) ) {
        class SeedReduxFramework_dimensions {
            ...
            function render() {
                ...
                if ( isset( $this->field['units'] ) && ! SeedRedux_Helpers::array_in_array( $this->field['units'], array(
                        '',
                        false,
                        '%',
                        'in',
                ...
                if ( isset( $this->value['units'] ) && ! SeedRedux_Helpers::array_in_array( $this->value['units'], array(
                        '',
                        '%',
                        'in',
                        'cm',
            ...
            function enqueue() {
                ...
                wp_enqueue_script(
                    'seedredux-field-dimensions-js',
                    SeedReduxFramework::$_url . 'inc/fields/dimensions/field_dimensions' . SeedRedux_Functions::isMin() . '.js',
                ...
                if ( $this->parent->args['dev_mode'] ) {
                    wp_enqueue_style(
                        'seedredux-field-dimensions-css',
                        SeedReduxFramework::$_url . 'inc/fields/dimensions/field_dimensions.css',
                        array(),
                        time(),
                        'all'
                    );
