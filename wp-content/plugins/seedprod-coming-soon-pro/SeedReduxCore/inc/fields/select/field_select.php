...
if ( ! class_exists( 'SeedReduxFramework_select' ) ) {
    class SeedReduxFramework_select {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['data'] ) && empty( $this->field['options'] ) ) {
                ...
                if ( $this->field['data'] == "elusive-icons" || $this->field['data'] == "elusive-icon" || $this->field['data'] == "elusive" ) {
                    ...
                    /**
                     * filter 'seedredux-font-icons-file}'
                     *
                    ...
                    /**
                     * filter 'seedredux/{opt_name}/field/font/icons/file'
                     *
                     * @param  array $icon_file File for the icons
                     */
                    $icons_file = apply_filters( "seedredux/{$this->parent->args['opt_name']}/field/font/icons/file", $icons_file );
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : __( 'Select an item', 'seedredux-framework' );
                ...
                echo '<select ' . $multi . ' id="' . $this->field['id'] . '-select" data-placeholder="' . $placeholder . '" name="' . $this->field['name'] . $this->field['name_suffix'] . $nameBrackets . '" class="seedredux-select-item ' . $this->field['class'] . $sortable . '"' . $width . ' rows="6">';
                echo '<option></option>';
                ...
                echo '<strong>' . __( 'No items of this type were found.', 'seedredux-framework' ) . '</strong>';
            }
        } //function
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                'seedredux-field-select-js',
                SeedReduxFramework::$_url . 'inc/fields/select/field_select' . SeedRedux_Functions::isMin() . '.js',
                array( 'jquery', 'select2-js', 'seedredux-js' ),
                time(),
                true
            );
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'seedredux-field-select-css',
                    SeedReduxFramework::$_url . 'inc/fields/select/field_select.css',
                    array(),
                    time(),
                    'all'
                );
