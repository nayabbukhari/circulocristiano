...
if ( ! class_exists( 'SeedReduxFramework_sortable' ) ) {
    class SeedReduxFramework_sortable {

        /**
         * Field Constructor.
         * Required - must call the parent constructor, then assign field and value to vars, and obviously call the render field function
         *
         * @since SeedRedux_Options 2.0.1
         */
        ...
        function render() {
            ...
            echo '<ul id="' . $this->field['id'] . '-list" class="seedredux-sortable ' . $class . ' ' . $label_class . '">';
        ...
        function enqueue() {
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'seedredux-field-sortable-css',
                    SeedReduxFramework::$_url . 'inc/fields/sortable/field_sortable.css',
                    array(),
                    time(),
                    'all'
                );
            ...
            wp_enqueue_script(
                'seedredux-field-sortable-js',
                SeedReduxFramework::$_url . 'inc/fields/sortable/field_sortable' . SeedRedux_Functions::isMin() . '.js',
