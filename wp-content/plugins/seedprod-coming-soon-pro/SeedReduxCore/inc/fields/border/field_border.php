...
// Don't duplicate me!
if ( ! class_exists( 'SeedReduxFramework_border' ) ) {
    
    class SeedReduxFramework_border {
        ...
        function render() {
            ...
            if ( isset( $this->field['all'] ) && $this->field['all'] == true ) {
                echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-fullscreen icon-large"></i></span><input type="text" class="seedredux-border-all seedredux-border-input mini' . $this->field['class'] . '" placeholder="' . __( 'All', 'seedredux-framework' ) . '" rel="' . $this->field['id'] . '-all" value="' . $this->value['top'] . '"></div>';
            }

            echo '<input type="hidden" class="seedredux-border-value" id="' . $this->field['id'] . '-top" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-top]" value="' . ( $this->value['top'] ? $this->value['top'] . 'px' : 0 ) . '">';
            echo '<input type="hidden" class="seedredux-border-value" id="' . $this->field['id'] . '-right" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-right]" value="' . ( $this->value['right'] ? $this->value['right'] . 'px' : 0 ) . '">';
            echo '<input type="hidden" class="seedredux-border-value" id="' . $this->field['id'] . '-bottom" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-bottom]" value="' . ( $this->value['bottom'] ? $this->value['bottom'] . 'px' : 0 ) . '">';
            echo '<input type="hidden" class="seedredux-border-value" id="' . $this->field['id'] . '-left" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-left]" value="' . ( $this->value['left'] ? $this->value['left'] . 'px' : 0 ) . '">';
            ...
            if ( ! isset( $this->field['all'] ) || $this->field['all'] !== true ) {
                ...
                if ( $this->field['top'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-up icon-large"></i></span><input type="text" class="seedredux-border-top seedredux-border-input mini' . $this->field['class'] . '" placeholder="' . __( 'Top', 'seedredux-framework' ) . '" rel="' . $this->field['id'] . '-top" value="' . $this->value['top'] . '"></div>';
                }
                ...
                if ( $this->field['right'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-right icon-large"></i></span><input type="text" class="seedredux-border-right seedredux-border-input mini' . $this->field['class'] . '" placeholder="' . __( 'Right', 'seedredux-framework' ) . '" rel="' . $this->field['id'] . '-right" value="' . $this->value['right'] . '"></div>';
                }
                ...
                if ( $this->field['bottom'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-down icon-large"></i></span><input type="text" class="seedredux-border-bottom seedredux-border-input mini' . $this->field['class'] . '" placeholder="' . __( 'Bottom', 'seedredux-framework' ) . '" rel="' . $this->field['id'] . '-bottom" value="' . $this->value['bottom'] . '"></div>';
                }
                ...
                if ( $this->field['left'] === true ) {
                    echo '<div class="field-border-input input-prepend"><span class="add-on"><i class="el el-arrow-left icon-large"></i></span><input type="text" class="seedredux-border-left seedredux-border-input mini ' . $this->field['class'] . '" placeholder="' . __( 'Left', 'seedredux-framework' ) . '" rel="' . $this->field['id'] . '-left" value="' . $this->value['left'] . '"></div>';
                }
            }
            ...
            if ( $this->field['style'] != false ) {
                ...
                echo '<select original-title="' . __( 'Border style', 'seedredux-framework' ) . '" id="' . $this->field['id'] . '[border-style]" name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-style]" class="tips seedredux-border-style ' . $this->field['class'] . '" rows="6" data-id="' . $this->field['id'] . '">';
            ...
            if ( $this->field['color'] != false ) {
                ...
                echo '<input name="' . $this->field['name'] . $this->field['name_suffix'] . '[border-color]" id="' . $this->field['id'] . '-border" class="seedredux-border-color seedredux-color seedredux-color-init ' . $this->field['class'] . '"  type="text" value="' . $this->value['color'] . '"  data-default-color="' . $default . '" data-id="' . $this->field['id'] . '" />';
            } else {
        ...
        function enqueue() {
            ...
            wp_enqueue_script(
                'seedredux-field-border-js',
                SeedReduxFramework::$_url . 'inc/fields/border/field_border' . $min . '.js',
                array( 'jquery', 'select2-js', 'wp-color-picker', 'seedredux-js' ),
                time(),
                true
            );
            ...
            if ($this->parent->args['dev_mode']) {
                ...
                wp_enqueue_style(
                    'seedredux-field-border-css',
                    SeedReduxFramework::$_url . 'inc/fields/border/field_border.css',
                    array(),
                    time(),
                    'all'
                );
