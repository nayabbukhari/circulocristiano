...
// Don't duplicate me!
    if ( ! class_exists( 'SeedReduxFramework_button_set' ) ) {

        /**
         * Main SeedReduxFramework_button_set class
         *
         * @since       1.0.0
         */
        class SeedReduxFramework_button_set {
            ...
            public function enqueue() {
                ...
                wp_enqueue_script(
                    'seedredux-field-button-set-js',
                    SeedReduxFramework::$_url . 'inc/fields/button_set/field_button_set' . SeedRedux_Functions::isMin() . '.js',
                    array( 'jquery', 'jquery-ui-core', 'seedredux-js' ),
                    time(),
                    true
                );
            }
