...
// Don't duplicate me!
if ( !class_exists ( 'SeedReduxFramework_checkbox' ) ) {

    /**
     * Main SeedReduxFramework_checkbox class
     *
     * @since       1.0.0
     */
    class SeedReduxFramework_checkbox {
        ...
        public function enqueue () {
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style (
                    'seedredux-field-checkbox-css', 
                    SeedReduxFramework::$_url . 'inc/fields/checkbox/field_checkbox.css', 
                    array(),
                    time (), 
                    'all'
                );
            ...
            wp_enqueue_script (
                'seedredux-field-checkbox-js', 
                SeedReduxFramework::$_url . 'inc/fields/checkbox/field_checkbox' . SeedRedux_Functions::isMin () . '.js', 
