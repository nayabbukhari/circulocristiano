...
if ( ! class_exists( 'SeedReduxFramework_select_image' ) ) {
    class SeedReduxFramework_select_image {
        ...
        function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                echo '<select data-id="' . $this->field['id'] . '" data-placeholder="' . $placeholder . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '" class="seedredux-select-item seedredux-select-images ' . $this->field['class'] . '"' . $width . ' rows="6">';
                echo '<option></option>';
                ...
                if ( '' == $this->value ) {
                    echo '<img src="#" class="seedredux-preview-image" style="visibility:hidden;" id="image_' . $this->field['id'] . '">';
                } else {
                    echo '<img src=' . $this->field['options'][ $arrNum - 1 ]['img'] . ' class="seedredux-preview-image" id="image_' . $this->field['id'] . '">';
                }
        ...
        function enqueue() {
            ...
            wp_enqueue_script(
                ...
                SeedReduxFramework::$_url . 'inc/fields/select_image/field_select_image' . SeedRedux_Functions::isMin() . '.js',
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'seedredux-field-select-image-css',
                    SeedReduxFramework::$_url . 'inc/fields/select_image/field_select_image.css',
                    array(),
                    time(),
                    'all'
                );
