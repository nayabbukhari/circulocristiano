...
(function( $ ) {
    ...
    seedredux.field_objects.gallery = seedredux.field_objects.gallery || {};

    $( document ).ready(
        function() {
            //seedredux.field_objects.gallery.init();
        }
    );

    seedredux.field_objects.gallery.init = function( selector ) {


        if ( !selector ) {
            selector = $( document ).find( '.seedredux-container-gallery:visible' );
        }
                                ...
                                'update', function( selection ) {
                                    ...
                                    var ids = selection.models.map(
                                        function( e ) {
                                            ...
                                            preview_html = "<a class='of-uploaded-image' href='" + preview_img + "'><img class='seedredux-option-image' src='" + preview_img + "' alt='' /></a>";
                                    ...
                                    seedredux_change( current_gallery.find( '.gallery_values' ) );
