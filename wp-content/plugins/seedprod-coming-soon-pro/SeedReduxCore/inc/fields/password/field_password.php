<?php
    ...
    /**
     * Class SeedReduxFramework_password
     */
...
// Exit if accessed directly
    ...
    if ( ! class_exists( 'SeedReduxFramework_password' ) ) {
        class SeedReduxFramework_password {
             ...
             *
             * @since SeedReduxFramework 1.0.1
             */
             ...
             *
             * @since SeedReduxFramework 3.0.9
             * @example
             *        <code>
             *        array(
             *        'id'          => 'smtp_account',
            ...
            private function _render_combined_field() {
                ...
                $defaults = array(
                    ...
                    'password'    => '',
                    'placeholder' => array(
                        'password' => __( 'Password', 'seedredux-framework' ),
                        'username' => __( 'Username', 'seedredux-framework' )
                    )
                );
