...
if ( ! class_exists( 'SeedReduxFramework_spacing' ) ) {
    class SeedReduxFramework_spacing {
...
//            }
        ...
        function enqueue() {
            ...
            wp_enqueue_script(
                'seedredux-field-spacing-js',
                SeedReduxFramework::$_url . 'inc/fields/spacing/field_spacing' . SeedRedux_Functions::isMin() . '.js',
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'seedredux-field-spacing-css',
                    SeedReduxFramework::$_url . 'inc/fields/spacing/field_spacing.css',
                    array(),
                    time(),
                    'all'
                );
