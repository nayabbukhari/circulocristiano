...
/**
 * Options Sorter Field for SeedRedux Options
 *
...
if ( ! class_exists( 'SeedReduxFramework_sorter' ) ) {
    class SeedReduxFramework_sorter {

        /**
         * Field Constructor.
         * Required - must call the parent constructor, then assign field and value to vars, and obviously call the render field function
         *
         * @since SeedRedux_Options 1.0.0
         */
        ...
        function render() {
            ...
            if ( is_array( $sortlists ) ) {
                ...
                if ( $sortlists ) {
                    echo '<fieldset id="' . $this->field['id'] . '" class="seedredux-sorter-container seedredux-sorter">';
        ...
        function enqueue() {
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                    'seedredux-field-sorder-css',
                    SeedReduxFramework::$_url . 'inc/fields/sorter/field_sorter.css',
                    array(),
                    time(),
                    'all'
                );
            ...
            wp_enqueue_script(
                'seedredux-field-sorter-js',
                SeedReduxFramework::$_url . 'inc/fields/sorter/field_sorter' . SeedRedux_Functions::isMin() . '.js',
                array( 'jquery', 'seedredux-js', 'jquery-ui-sortable' ),
                time(),
                true
            );
        }
         ...
         * @since  SeedRedux_Framework 3.1.5
         */
