<?php
    ...
    if ( ! class_exists( 'SeedRedux_Filesystem' ) ) {
        class SeedRedux_Filesystem {
            private $parent = null;
            ...
            public function execute( $action, $file = '', $params = '' ) {
                ...
                $url = wp_nonce_url( $base, 'seedredux-options' );
            ...
            public function do_action( $action, $file = '', $params = '' ) {
                ...
                if ( ! $res ) {
                    add_action( "seedredux/page/{$this->parent->args['opt_name']}/form/before", array(
                        $this,
                        'ftp_form'
                    ) );
                }
