<?php
    ...
    class SeedRedux_P {
        ...
        public function __construct() {
            ...
            add_action( "wp_ajax_nopriv_seedredux_p", array( $this, 'proxy' ) );
            add_action( "wp_ajax_seedredux_p", array( $this, 'proxy' ) );
        }

        public function proxy() {

            if ( ! isset( $_GET['nonce'] ) || ( isset( $_GET['nonce'] ) && ! wp_verify_nonce( $_GET['nonce'], "seedredux-ads-nonce" ) ) ) {
                die();
            }
...
// ############################################################################
            ...
            if ( isset( $_GET['mode'] ) && $_GET['mode'] == 'native' ) {
                ...
                print str_replace( 'ads.seedreduxframework.com', 'look.seedreduxframework.com', $contents );
