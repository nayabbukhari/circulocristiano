<?php
    ...
    /**
     * SeedRedux Framework Instance Container Class
     * Automatically captures and stores all instances
     * of SeedReduxFramework at instantiation.
     *
     * @package     SeedRedux_Framework
     * @subpackage  Core
     */
    class SeedReduxFrameworkInstances {

        /**
         * SeedReduxFrameworkInstances
         *
         * @var object
         */
        ...
        /**
         * Get Instance
         * Get SeedReduxFrameworkInstances instance
         * OR an instance of SeedReduxFramework by [opt_name]
         *
        ...
        /**
         * Get all instantiated SeedReduxFramework instances (so far)
         *
        ...
        private function __construct() {
            ...
            add_action( 'seedredux/construct', array( $this, 'capture' ), 5, 1 );
            ...
            if (!class_exists('SeedRedux_Tracking') || !method_exists('SeedRedux_Tracking', 'trackingObject')) {
        ...
        function capture( $SeedReduxFramework ) {
            $this->store( $SeedReduxFramework );
        }

        private function store( $SeedReduxFramework ) {
            if ( $SeedReduxFramework instanceof SeedReduxFramework ) {
                $key                     = $SeedReduxFramework->args['opt_name'];
                self::$instances[ $key ] = $SeedReduxFramework;
            }
        }
    }
