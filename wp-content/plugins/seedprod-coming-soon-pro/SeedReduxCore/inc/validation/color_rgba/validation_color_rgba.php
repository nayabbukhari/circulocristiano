<?php
    if ( ! class_exists( 'SeedRedux_Validation_color_rgba' ) ) {
        class SeedRedux_Validation_color_rgba {
            ...
            function __construct( $parent, $field, $value, $current ) {
                $this->parent       = $parent;
                $this->field        = $field;
                $this->field['msg'] = ( isset( $this->field['msg'] ) ) ? $this->field['msg'] : __( 'This field must be a valid color value.', 'seedredux-framework' );
                $this->value        = $value;
