(function( $ ) {
    ...
    $.seedredux_welcome = $.seedredux_welcome || {};

    $( document ).ready(
        function() {
            $.seedredux_welcome.initQtip();
            if ( jQuery( document.getElementById( "support_div" ) ).is( ":visible" ) ) {
                $.seedredux_welcome.initSupportPage();
            }
            $.seedredux_welcome.supportHash();
        }
    );


    $.seedredux_welcome.supportHash = function() {
        ...
        jQuery( '.seedredux_support_hash' ).click(
            function( e ) {
                ...
                var $nonce = jQuery( '#seedredux_support_nonce' ).val();
                ...
                jQuery.ajax(
                    {
                        ...
                        success: function( response ) {
                            if ( response.status == "success" ) {
                                jQuery( '#support_hash' ).val( 'http://support.seedredux.io/?id=' + response.identifier );
    ...
    $.seedredux_welcome.initSupportPage = function() {
        //jQuery time
    ...
    $.seedredux_welcome.initQtip = function() {
        if ( $().qtip ) {
