<?php 
	...
	*/
	...
	define('DB_USERNAME','circuloc_wpc148c'); 
	...
	*/
	...
	define('DB_USERTABLE_AVATAR','user_email'); 
	
	define('DB_FRIENDSTABLE','bp_friends'); 
	define('DB_FRIENDSTABLE_USERID', 'initiator_user_id'); 
	define('DB_FRIENDSTABLE_FRIENDID', 'friend_user_id'); 
	define('DB_FRIENDSTABLE_FRIENDS', 'is_confirmed');
